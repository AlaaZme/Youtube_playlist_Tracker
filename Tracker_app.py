...
for user in user_names:
    ...
    updated = driver.find_elements(by="xpath", value="//*[@id='metadata-line']/span")
...
# driver.find_element(by="xpath",value='//input[@id=\"search\"]').click()
# search = driver.find_element(by="xpath",value='//input[@id=\"search\"]')
# search.send_keys('python bot')
# driver.find_element(by="xpath",value="//*[@id=\"search-icon-legacy\"]").click()
